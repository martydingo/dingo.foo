            ...
            <div className="relative flex w-full flex-col items-center justify-center">
                <div className="mr-0 mb-4 md:mr-4 md:flex"><a
                    ...
                    href="/"><Image alt="logo" width="30" height="30" src={siteImageUri!} /><span
                        className="font-medium text-black dark:text-white">dingo.foo</span></a></div>
                <ul
                    className="hover:text-text-neutral-800 flex list-none flex-col gap-4 text-neutral-600 transition-colors sm:flex-row dark:text-neutral-300">
